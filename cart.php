        ...
        <div class="cc_menu_wrapper">
            ...
            <div class="application_wrapper">
                ...
                <form method="post" action="./confirm_order.php" onsubmit="return validateForm('order');">
                    ...
                    <label for="streetaddress" class="label_jobapplication">Street address*</label><input class="input_jobapplication" name="streetaddress" id="streetaddress" type="text" placeholder="Zip code" required><br>
